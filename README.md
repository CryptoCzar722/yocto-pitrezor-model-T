...
In the end Persistence was the key, it took around 6 failed builds before I had a successful one. I have heard a build server can reduce this time from many hours to sub 30 mintues. 